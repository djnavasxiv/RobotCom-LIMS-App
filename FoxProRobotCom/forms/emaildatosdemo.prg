...
Try
	...
	With loConfig.Fields
		...
		.Item(lcSchema + "sendusername") = "robotcomlabdemo@gmail.com"
	...
	With loMsg
		...
		.From = "robotcomlabdemo@gmail.com"
		.To = "programalabo@hotmail.com"
		.Subject = " QUIERO DEMOSTRACION: "+MRAZON
		.TextBody = "EQUIPO: " + WEQUIPO +  Chr(13)+ ;
			" USUARIO "+ WUSUARIO + Chr(13)+ ;
			" EMPRESA "+ ALLTRIM(m.empresa)+ Chr(13)+;
			"PROPIETARIO:" + ALLTRIM(M.PROPIETA) +Chr(13)+;
			""+m.regisalud +Chr(13)+;
			" TELEFONO: "+m.TELEFONO+Chr(13)+;
			"IP:" + v_ip + +Chr(13)+;
			" HD:"+PSERIEDISCO+Chr(13)+;
	...
	Messagebox("Datos enviados",48,"Envio de datos")
